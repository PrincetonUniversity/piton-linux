...
static void sunhv_console_poll(struct timer_list *timer);

//static struct timer_list sunhv_timer;
//	sunhv_timer = __TIMER_INITIALIZER(sunhv_console_poll, 0)

static DEFINE_TIMER(sunhv_timer, sunhv_console_poll);

#endif /* #ifdef CONFIG_OPENSPARC_T1_FPGA */
...
#ifndef CONFIG_OPENSPARC_T1_FPGA
...
#endif /* ifndef CONFIG_OPENSPARC_T1_FPGA */
...
static void sunhv_console_poll(struct timer_list *timer)
{
	...
	mod_timer(timer, jiffies + sunhv_console_polling_period);
}
#endif /* ifndef CONFIG_OPENSPARC_T1_FPGA */
...
#else /* ifndef CONFIG_OPENSPARC_T1_FPGA */
